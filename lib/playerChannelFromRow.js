...
import { readAuthorizedPackageName } from './authorizedPackageName';
import {
 ...
 * @returns {string}
 */
function readAuthorizedPackageNameFromRow(raw) {
  return readAuthorizedPackageName(raw);
}
  ...
  const playerType =
    raw?.playerType != null
      ...
      : raw?.player_type != null
        ...
        : 'exo';
  const authorizedPackageName = readAuthorizedPackageNameFromRow(raw);
  return {
    id: channelId,
    ...
    authorizedPackageName: authorizedPackageName || undefined,
    authorized_package_name: authorizedPackageName || undefined,
