/**
 * Chromium-class WebView settings for admin `playerType: chrome`.
 * Uses Android System WebView (Chromium) via react-native-webview with full
 * browser features: JS, cookies, DOM storage, iframes, redirects, embeds.
 */
