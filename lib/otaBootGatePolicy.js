...
import { isPlayStoreVpsBuild, isNativeVpsPlayRelease, probeApiHostRouting } from './playVpsApiHost';
...
export function shouldRunOtaBootGate() {
  if (!isExpoUpdatesRuntimeEnabled()) return false;
  /** v23+ native VPS APK / v24 Play release — never block Home for embedded migration. */
  if (isNativeVpsPlayRelease()) return false;
