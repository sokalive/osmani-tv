 ...
 */
export function resolveTrialWatchAllowance(state, settings = DEFAULT_TRIAL_WATCH_SETTINGS) {
 ...
 */
export function applyTrialWatchConsumption(state, deltaMs, settings = DEFAULT_TRIAL_WATCH_SETTINGS) {
  const trialBudget = trialMsFromSettings(settings);
