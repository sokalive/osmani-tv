 ...
 *
 * `/stream-proxy` defaults to Contabo Admin API (EXPO_PUBLIC_STREAM_PROXY_URL).
 * Legacy Render URLs in catalog JSON are rewritten to Contabo.
...
/** Hosts that historically served API media from Render — rewrite away from these. */
