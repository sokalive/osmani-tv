...
/**
 * Stable install_id for security challenge/report binding (same as install instance UUID).
 * Regenerates only after uninstall / clear app storage — never per scan.
 * @returns {Promise<string>}
 */
export async function getSecurityInstallId() {
  return getInstallInstanceId();
}
...
export async function getDeviceIdentity() {
  ...
  // package_android_id before stable_hardware_id — admin binds subscriptions to SSAID.
