...
/**
 * Remove wrong-device or inactive AsyncStorage hints before backend recovery.
 * Never purge same-device active hints — backend verify repairs timing.
 *
...
export async function purgeUnreliableSubscriptionCache() {
  try {
    ...
    const mustPurge = !sameDevice || cached.active !== true;
