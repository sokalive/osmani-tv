import { LEGACY_HTTPS_API_FALLBACK, resolveApiBaseUrl } from './apiBaseUrl';
...
export function getAdminApiBases() {
  ...
  if (
    ...
    primary.toLowerCase() !== LEGACY_HTTPS_API_FALLBACK.toLowerCase()
  ) {
    return [primary, LEGACY_HTTPS_API_FALLBACK];
  }
  return [primary];
}
