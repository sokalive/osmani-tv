...
/** Must stay below {@link OsmaniAppContext} LIVE_SYNC_BASE_MS (30s) so foreground ticks fetch fresh accessType. */
const CHANNELS_TTL_MS = 15_000;
const BANNERS_TTL_MS = 15_000;
