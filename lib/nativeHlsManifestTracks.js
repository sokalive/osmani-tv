...
function resolveStreamProxyBase() {
  if (typeof process !== 'undefined' && process.env?.EXPO_PUBLIC_STREAM_PROXY_URL) {
    return String(process.env.EXPO_PUBLIC_STREAM_PROXY_URL).replace(/\/+$/, '');
  }
  return 'https://osmanitv.b-cdn.net/stream-proxy';
}
