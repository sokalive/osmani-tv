...
/**
 * Publish cold-start entitlement race fix OTA to every Play runtime (16–24).
 * Usage: node scripts/publish-cold-start-entitlement-ota.js
 */
...
fs.writeFileSync(logPath, `[publish-cold-start-entitlement-ota] started ${new Date().toISOString()}\n`);
...
console.log('\n[publish-cold-start-entitlement-ota] all runtimes published');
console.log('[publish-cold-start-entitlement-ota] summary', JSON.stringify(groups, null, 2));
